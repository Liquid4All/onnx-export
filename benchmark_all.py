...
Usage:
    ...
    uv run benchmark_all.py --models 350M 1.2B
    uv run benchmark_all.py --quant q4       # Only Q4
    uv run benchmark_all.py --quant q8       # Only Q8
    uv run benchmark_all.py --prompt "Hello world" --max-tokens 50
"""
...
def main():
    ...
    for size in args.models:
        ...
        if "q4" in args.quant:
            ...
            try:
                result = benchmark.benchmark(
                    size, builder_path, tokenizer_path, "builder", "q4",
            ...
            try:
                result = benchmark.benchmark(
                    size, community_path, tokenizer_path, "community", "q4",
                    args.prompt, args.max_tokens
                )
                results.append(result)
                print(f"  Size: {result.file_size_mb:.1f} MB")
        ...
        if "q8" in args.quant:
            ...
            try:
                result = benchmark.benchmark(
                    size, builder_path, tokenizer_path, "builder", "q8",
                    args.prompt, args.max_tokens
                )
                results.append(result)
                print(f"  Size: {result.file_size_mb:.1f} MB")
            ...
            try:
                result = benchmark.benchmark(
                    size, community_path, tokenizer_path, "community", "q8",
                    args.prompt, args.max_tokens
                )
                results.append(result)
                print(f"  Size: {result.file_size_mb:.1f} MB")
