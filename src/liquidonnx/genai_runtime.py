...
Expects a build of onnxruntime-genai main at liquidonnx.genai_builder.GENAI_COMMIT. The 0.16
release runs the LFM2 text models only; lfm2_moe, lfm2_vl and lfm2_audio are on main.
"""
